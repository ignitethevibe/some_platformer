...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        sprite_sheet = SpriteSheet('Spider-ManRESIZE.png')
        # Load all the right facing images into a list
        image = sprite_sheet.get_image(114,23,65,102)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(199,24,59,100)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(273,26,65,95)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(352,23,65,98)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(433,26,65,95)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(510,36,66,84)
        self.walking_frames_r.append(image)
        ...
        image = pygame.transform.flip(image, True, False)
        self.walking_frames_l.append(image)
        image = sprite_sheet.get_image(352,23,65,95)
        image = pygame.transform.flip(image, True, False)
        self.walking_frames_l.append(image)
        image = sprite_sheet.get_image(433,26,65,95)
        image = pygame.transform.flip(image, True, False)
